# Autogenerated wrapper script for CeresSolver_jll for x86_64-apple-darwin14-cxx11
export libceres
...
const libceres_splitpath = ["lib", "libceres.1.14.0.dylib"]
...
const libceres = "@rpath/libceres.1.dylib"
