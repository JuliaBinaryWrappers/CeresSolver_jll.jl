...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CeresSolver_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("274fe647-06be-54d6-af78-99f37f3755f2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CeresSolver", artifacts_toml) for e in artifacts["CeresSolver"]]
...
if best_platform === nothing
    @debug("Unable to load CeresSolver; unsupported platform $(triplet(platform_key_abi()))")
else
